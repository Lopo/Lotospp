...
std::string Bcrypt::crypt(const std::string& password, const std::string algo/*=""*/)
{
	std::string setting;
	char out[61];
	if (algo=="") {
 ...
 * setting.
 */
char* Bcrypt::crypt_blowfish_rn(const char *key, const char *setting, char *output, int size)
{
